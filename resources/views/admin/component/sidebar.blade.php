    ...
    <div class="sidebar">
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{route('admin.dashboard')}}" class="nav-link {{ request()->is('admin/home') ? 'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="{{route('images.index')}}" class="nav-link {{ request()->is('galery/*') ? 'active' : '' }}">
          ...
          <li class="nav-item">
            <a href="{{route('costumer.index')}}" class="nav-link {{ request()->is('pelanggan/*') ? 'active' : '' }}">
              <i class="fas fa-user"></i>
              <p>
                Costumer
              </p>
