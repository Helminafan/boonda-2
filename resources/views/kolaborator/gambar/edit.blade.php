    ...
    <div class="content-wrapper">
        <section class="content">
            <div class="container-xxl flex-grow-1 container-p-y">
                <div class="card">
                    <h5 class="card-header">Edit Galerry</h5>
                    <div class="card-body">
                        <form action="{{ route('galery_kolaborator.update', $editData->id) }}" method="POST"
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control @error('nama') is-invalid @enderror"
                                    id="nama" name="nama" value="{{ old('nama', $editData->nama) }}" required />
                                @error('nama')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control @error('tahun') is-invalid @enderror"
                                    id="tahun" name="tahun" value="{{ old('tahun', $editData->tahun) }}" required />
                                @error('tahun')
                                    <div class="invalid-feedback">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                    <img src="{{ asset('storage/' . $editData->foto) }}" alt="Current Project Image"
